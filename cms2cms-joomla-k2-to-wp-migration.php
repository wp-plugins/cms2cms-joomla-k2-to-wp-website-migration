<?php
/*
    Plugin Name: CMS2CMS JOOMLA K2 to WordPress migration
    Plugin URI: http://www.cms2cms.com
    Description: Migrate your website content from JOOMLA K2 to WordPress easily and automatedly in just a few simple steps.
    Version: 1.0.1
    Author: MagneticOne
